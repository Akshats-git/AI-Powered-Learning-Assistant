...
const RegisterPage = () => {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Start turning documents into study material"
      footer={<p>By continuing, you agree to our Terms of Service and Privacy Policy.</p>}
    >
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-3 py-2.5 rounded-lg border text-sm outline-none transition focus:ring-2 focus:ring-primary/30 ${
                errors.username ? "border-red-300" : "border-gray-200 focus:border-primary"
              }`}
            />
          </div>
